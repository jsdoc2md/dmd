...
function DmdOptions () {
  ...
  */
   ...
   * @type number
   * @default
   * @member module:dmd~DmdOptions#heading-depth
   */
   ...
   * @type {string}
   * @default
   * @member module:dmd~DmdOptions#example-lang
   */
   ...
   * @type {string}
   * @member module:dmd~DmdOptions#name-format
   */
  this['name-format']
   ...
   * @type {boolean}
   * @member module:dmd~DmdOptions#no-gfm
   */
  this['no-gfm']
   ...
   * @type {string}
   * @default
   * @member module:dmd~DmdOptions#module-index-format
   */
   ...
   * @type {string}
   * @default
   * @member module:dmd~DmdOptions#global-index-format
   */
   ...
   * @type {string}
   * @default
   * @member module:dmd~DmdOptions#param-list-format
   */
   ...
   * @type {string}
   * @default
   * @member module:dmd~DmdOptions#property-list-format
   */
  this['property-list-format'] = 'table'

  /**
   * grouped, list
   * @member module:dmd~DmdOptions#member-index-format
   * @type {string}
   * @default 'grouped'
   */
   ...
   * @type {array}
   * @default
   * @member module:dmd~DmdOptions#group-by
   */
...
/* Searches for module by specific directory name under node_modules, does not support relative modules like './' or './modules/something' */
