...
@param {number} [options.heading-depth] - the heading depth to begin the docs from (e.g. `2` starts from a markdown heading of `##`). Defaults to `1`.
...
dmd.cliOptions = [
    ...
    { name: "module-index-format", type: String,
      description: "list, table, dl"
    },
    { name: "global-index-format", type: String,
      description: "list, table, dl"
    },
    { name: "param-list-format", type: String,
      description: "list, table"
    },
    { name: "property-list-format", type: String,
      description: "list, table"
    }
    // { name: "class-member-list-format", type: String,
